...
<div class="container">
    <div class="col-md-12 about_us">
        ...
        <br><br>
        <strong>Vision: </strong> To create a tolerant, liberal, happy, connected and humane society using art as a medium of change.
        <br>
        <strong>Mission: </strong> To create opportunities to expose a large population to contemporary art and thus break the cultural barrier.
        <br><br>
