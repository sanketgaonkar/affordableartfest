...
<section class="content container-fluid partner_sponsors">
    ...
    <table class="table table-bordered">
		<thead>
			<tr><td colspan="3" class="text-center hdng">Top level</td></tr>
			<tr>
				<!--th>Title</th-->
				<th>Name</th>
				<th>Description</th>
       ...
       <thead>
			<tr><td colspan="3" class="text-center hdng">Mid level</td></tr>
			<tr>
				<!--th>Title</th-->
				<th>Name</th>
				<th>Description</th>
		...
		<thead>
			<tr><td colspan="3" class="text-center hdng">Partners</td></tr>
			<tr>
				<!--th>Title</th-->
				<th colspan="2">Tag</th>
				<th class="text-center"><i class="fa fa-cog"></i></th>
		...
		<thead>
			<tr><td colspan="3" class="text-center hdng">Sponsors</td></tr>
			<tr>
				<!--th>Title</th-->
				<th colspan="2">Tag</th>
				<th class="text-center"><i class="fa fa-cog"></i></th>
