...
<section class="content container-fluid partner_sponsors">
    ...
    <div class="col-md-12 table_top_div">
        <h4 class="card-title"><i class="fa fa-list"></i><?= $table_heading ?></h4>
    </div>
    <table class="table table-bordered">
        <tr><td colspan="4" class="text-center hdng">Head</td></tr>
        <tr>
        ...
        <tr><td colspan="4" class="text-center hdng">Mid</td></tr>
