...
<section class="content container-fluid">
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="sort_order" class="form-control" id="sort_order" value="<?=(isset($guidelines_to_apply['sort_order']))?$guidelines_to_apply['sort_order']:""?>" required/>
        </div>
        <div class="form-group col-md-12 desc">
            <label for="summernote">description:</label>
            <textarea id="summernote" class="form-control" name="description"><?=(isset($guidelines_to_apply['description']))?$guidelines_to_apply['description']:""?></textarea>
        </div>
    </form>
</section>
